...
CREATE TABLE Prueba (
  ...
  min_exh NUMBER(7,2) NOT NULL,
  max_exh NUMBER(7,2) NOT NULL,
  avg_exh NUMBER(7,2) NOT NULL,
  min_inh NUMBER(7,2) NOT NULL,
  max_inh NUMBER(7,2) NOT NULL,
  avg_inh NUMBER(7,2) NOT NULL,
